...
Report bugs at https://github.com/zeroae/ght/issues.
...
The best way to send feedback is to file an issue at https://github.com/zeroae/ght/issues.
...
Ready to contribute? Here's how to set up `ght` for local development.

1. Fork the `ght` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/ght.git

3. Install your local copy into a conda environment. Assuming you have conda installed, this is how you set up your fork for local development::

    $ cd ght/
    $ make init
    $ conda activate ght-dev
